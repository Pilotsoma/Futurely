...
const S: Record<string, React.CSSProperties> = {
  ...
  textarea:    { background: 'var(--bg)', border: '1px solid var(--border)', borderRadius: 8, padding: '10px 12px', fontSize: 14, color: 'var(--text)', resize: 'vertical' as const, fontFamily: 'inherit', lineHeight: 1.5, boxShadow: 'var(--neo-inset)' },

    ...
    <div style={{ background: 'var(--bg)', minHeight: '100vh', overflowX: 'hidden' }}>
        ...
        <div style={{ maxWidth: 1160, margin: '0 auto', padding: '0 28px', height: 60, display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
          <motion.div initial={{ opacity: 0, x: -16 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, ease: [0.19, 1, 0.22, 1] }}
            ...
            <div style={{
              ...
              background: 'linear-gradient(135deg, #2D6A4F 0%, #2B4A8E 100%)',
              display: 'flex', alignItems: 'center', justifyContent: 'center',
              fontSize: 14, fontWeight: 800, color: '#fff', letterSpacing: '-0.5px',
            }}>F</div>
            <span style={{ fontSize: 16, fontWeight: 600, color: 'var(--text)', letterSpacing: '-0.4px' }}>Futurely</span>
          </motion.div>
          <motion.div initial={{ opacity: 0, x: 16 }} animate={{ opacity: 1, x: 0 }} transition={{ duration: 0.5, ease: [0.19, 1, 0.22, 1] }}>
      ...
      <footer style={{ borderTop: '1px solid var(--border)', padding: '32px 28px', textAlign: 'center', color: 'var(--text-muted)', fontSize: 13 }}>
        <div style={{ display: 'flex', alignItems: 'center', gap: 8, justifyContent: 'center', marginBottom: 8 }}>
          <div style={{ width: 20, height: 20, borderRadius: 6, background: 'linear-gradient(135deg, #2D6A4F, #2B4A8E)', display: 'flex', alignItems: 'center', justifyContent: 'center', fontSize: 10, fontWeight: 900, color: '#fff' }}>F</div>
          <span style={{ fontWeight: 600, color: 'var(--text-secondary)' }}>Futurely</span>
        </div>

    ...
    <div className="fade-up">
      ...
      <div style={S.layout}>
        ...
        <div style={{ flex: 1, minWidth: 0 }}>
          ...
          {/* Agentic/autonomous AI features — DEV/ADMIN only until a premium tier
              exists (see backend requirePremiumAiAccess). Hidden entirely for
              everyone else rather than shown locked, since there's nothing a
              regular user can do with either link right now. */}

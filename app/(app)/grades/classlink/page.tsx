...
const S: Record<string, React.CSSProperties> = {
  ...
  section:    { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 14, padding: '20px 20px 24px', marginBottom: 16, boxShadow: 'var(--neo-raised)' },
  ...
  input:      { width: '100%', padding: '10px 13px', borderRadius: 9, border: '1px solid var(--border)', background: 'var(--surface-2, var(--background))', color: 'var(--text)', fontSize: 14, boxSizing: 'border-box', marginBottom: 16, outline: 'none', fontFamily: 'inherit', boxShadow: 'var(--neo-inset)' } as React.CSSProperties,
  ...
  eyeBtn:       { flexShrink: 0, background: 'var(--surface-2, var(--background))', border: '1px solid var(--border)', borderRadius: 9, width: 42, height: 42, display: 'flex', alignItems: 'center', justifyContent: 'center', cursor: 'pointer', color: 'var(--text-secondary)', boxShadow: 'var(--neo-raised)' },
  ...
  disclaimer:   { display: 'flex', gap: 8, alignItems: 'flex-start', padding: '11px 13px', borderRadius: 9, background: 'var(--surface-2, rgba(0,0,0,0.04))', border: '1px solid var(--border)', color: 'var(--text-secondary)', fontSize: 12, lineHeight: 1.6, marginBottom: 16, boxShadow: 'var(--neo-inset)' },
  connectBtn:   { width: '100%', padding: '13px 0', borderRadius: 11, border: 'none', background: 'var(--primary)', color: '#fff', fontWeight: 700, fontSize: 15, cursor: 'pointer', boxShadow: 'var(--neo-raised)' },
  ...
  successCard:  { background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 16, padding: '32px 24px', display: 'flex', flexDirection: 'column' as const, alignItems: 'center', textAlign: 'center' as const, boxShadow: 'var(--neo-raised)' },
  ...
  actionBtn:    { display: 'inline-block', padding: '11px 18px', borderRadius: 10, background: 'var(--primary)', color: '#fff', fontWeight: 700, fontSize: 13, textDecoration: 'none', boxShadow: 'var(--neo-raised)' },
  actionBtnSecondary: { display: 'inline-block', padding: '11px 18px', borderRadius: 10, border: '1px solid var(--border)', background: 'transparent', color: 'var(--text-secondary)', fontWeight: 600, fontSize: 13, textDecoration: 'none', boxShadow: 'var(--neo-raised)' },
}

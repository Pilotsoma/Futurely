...
const S: Record<string, React.CSSProperties> = {
  ...
  dropdown:        { position: 'absolute', top: '100%', left: 0, right: 0, zIndex: 50, background: 'var(--surface)', border: '1px solid var(--border)', borderRadius: 8, padding: 8, marginTop: 4, boxShadow: 'var(--neo-raised), var(--shadow-md)' },
  ...
  gpaRow:          { display: 'flex', background: 'var(--surface-2)', borderRadius: 10, padding: '12px 0', marginBottom: 16, border: '1px solid var(--border)', boxShadow: 'var(--neo-raised)' },

...
const S: Record<string, React.CSSProperties> = {
  ...
  aiLogo:     { width: 38, height: 38, borderRadius: 11, background: 'linear-gradient(135deg,#2D6A4F,#2B4A8E)', color: '#FFFFFF', display: 'flex', alignItems: 'center', justifyContent: 'center', flexShrink: 0 },
